      ...
      <div className="max-w-7xl mx-auto space-y-6">
        ...
        <div className="flex flex-col lg:flex-row justify-between items-start lg:items-center gap-4">
          ...
          <div className="flex gap-3">
            <select
              value={viewMode}
              onChange={(e) => setViewMode(e.target.value)}
              className="px-4 py-2 bg-white dark:bg-gray-800 border border-gray-300 dark:border-gray-600 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-all duration-200 shadow-sm hover:shadow-md font-medium text-gray-900 dark:text-white"
            >
              <option value="jour">Vue Jour</option>
              <option value="semaine">Vue Semaine</option>
              <option value="mois">Vue Mois</option>
        ...
        <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-lg border border-gray-100 dark:border-gray-700 p-4">
          <div className="flex items-center gap-2 mb-3">
            ...
            <h3 className="text-sm font-semibold text-gray-700 dark:text-gray-300">Légende des statuts</h3>
          </div>
          <div className="flex flex-wrap gap-4">
            {[
              { statut: 'planifiee', icon: '📅' },
        ...
        <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-lg border border-gray-100 dark:border-gray-700 p-6">
          <div className="flex flex-col lg:flex-row gap-4">
            ...
            <button
              ...
              className={`flex items-center gap-2 px-4 py-3 rounded-xl transition-all duration-200 font-medium ${
                hasActiveFilters 
                  ...
                  : 'bg-gray-50 dark:bg-gray-700 border border-gray-200 dark:border-gray-600 hover:bg-gray-100 dark:hover:bg-gray-600 text-gray-700 dark:text-gray-300'
              }`}
            >
              <Filter size={18} />
              Filtres
            ...
            {hasActiveFilters && (
              <button
                onClick={resetFilters}
                className="flex items-center gap-2 px-4 py-3 bg-red-50 dark:bg-red-900/30 border border-red-200 dark:border-red-700 text-red-700 dark:text-red-300 rounded-xl hover:bg-red-100 dark:hover:bg-red-800/50 transition-all duration-200 font-medium"
              >
                <RotateCcw size={18} />
                Réinitialiser
              </button>
            ...
            <div className="mt-6 p-4 bg-gradient-to-r from-gray-50 to-blue-50 dark:from-gray-700 dark:to-blue-900/20 rounded-xl border border-gray-200 dark:border-gray-600">
              ...
              <div className="mt-4 pt-4 border-t border-gray-300 dark:border-gray-600">
                <p className="text-sm text-gray-600 dark:text-gray-400 text-center">
                  <span className="font-bold text-blue-600 dark:text-blue-400">{myInterventions.length}</span> intervention(s) trouvée(s)
                  {(filterDateDebut || filterDateFin) && (
        ...
        <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-lg border border-gray-100 dark:border-gray-700 p-6">
          ...
          <div className="flex justify-between items-center mb-6">
            <button
              ...
              className="px-5 py-2.5 bg-gradient-to-r from-gray-100 to-gray-200 dark:from-gray-700 dark:to-gray-600 hover:from-gray-200 hover:to-gray-300 dark:hover:from-gray-600 dark:hover:to-gray-500 rounded-xl transition-all duration-200 font-medium shadow-sm hover:shadow-md text-gray-700 dark:text-gray-300"
            >
              ← Précédent
            </button>
                    ...
                    <div className="flex justify-between items-start">
                      <div className="flex-1">
                        ...
                        <div className="ml-5 space-y-1">
                          ...
                          {intervention.priorite && (
                            <span className={`inline-flex items-center gap-1 px-2 py-1 rounded-full text-xs font-medium ${
                              intervention.priorite === 'haute' ? 'bg-red-100 dark:bg-red-900/30 text-red-700 dark:text-red-300' :
                              intervention.priorite === 'moyenne' ? 'bg-yellow-100 dark:bg-yellow-900/30 text-yellow-700 dark:text-yellow-300' :
            ...
            <div className="grid grid-cols-7 gap-3">
              {getWeekDays().map((day, idx) => {
                ...
                return (
                  ...
                  >
                    <div className={`font-bold text-sm mb-3 pb-2 border-b-2 ${
                      isToday ? 'border-blue-500 text-blue-700 dark:text-blue-300' : 'border-gray-200 dark:border-gray-600 text-gray-700 dark:text-gray-300'
                    }`}>
                      <p className="capitalize">
                        {day.toLocaleDateString('fr-FR', { weekday: 'short' })}
                      </p>
                      <p className={`text-lg ${isToday ? 'text-blue-600 dark:text-blue-400' : 'text-gray-800 dark:text-gray-200'}`}>
                        {day.getDate()}
                      </p>
                    </div>
                    <div className="space-y-2">
                      {getInterventionsForDate(day).map(intervention => {
                        ...
                        return (
                          ...
                          >
                            ...
                            <p className={`font-medium truncate ${styles.text}`}>{intervention.titre}</p>
                            <p className="text-gray-600 dark:text-gray-400 text-[10px] truncate mt-1 flex items-center gap-1">
                              <MapPin size={10} />
                              {intervention.lieu}
                            </p>
                          </div>
          ...
          {viewMode === 'mois' && (
            <div>
              <div className="grid grid-cols-7 gap-2 mb-2">
                {['Lun', 'Mar', 'Mer', 'Jeu', 'Ven', 'Sam', 'Dim'].map(day => (
                  <div key={day} className="text-center font-bold text-sm p-2 text-gray-700 dark:text-gray-300 bg-gray-50 dark:bg-gray-700 rounded-lg">
                    {day}
                  </div>
                ))}
              </div>
          ...
          <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-2xl max-w-2xl w-full max-h-[90vh] overflow-hidden">
            ...
            <div className="p-6 space-y-5 max-h-[calc(90vh-180px)] overflow-y-auto">
              ...
              <div className="flex items-start gap-3 p-4 bg-blue-50 dark:bg-blue-900/20 rounded-xl border border-blue-200 dark:border-blue-700">
                ...
                <div>
                  <p className="font-semibold text-gray-800 dark:text-white mb-1">Date et heure</p>
              ...
              {selectedIntervention.lieu && (
                <div className="flex items-start gap-3 p-4 bg-red-50 dark:bg-red-900/20 rounded-xl border border-red-200 dark:border-red-700">
                  <MapPin className="w-5 h-5 text-red-600 dark:text-red-400 mt-1 flex-shrink-0" />
                  <div>
                    <p className="font-semibold text-gray-800 dark:text-white mb-1">Lieu</p>
                    <p className="text-gray-700 dark:text-gray-300">{selectedIntervention.lieu}</p>
                  </div>
                </div>
              )}
              ...
              {selectedIntervention.technicien && (
                <div className="flex items-start gap-3 p-4 bg-purple-50 dark:bg-purple-900/20 rounded-xl border border-purple-200 dark:border-purple-700">
                  <User className="w-5 h-5 text-purple-600 dark:text-purple-400 mt-1 flex-shrink-0" />
                  <div>
                    <p className="font-semibold text-gray-800 dark:text-white mb-1">Technicien assigné</p>
                    <p className="text-gray-700 dark:text-gray-300">
                      {selectedIntervention.technicien.prenom} {selectedIntervention.technicien.nom}
                    </p>
                    {selectedIntervention.technicien.email && (
                      <p className="text-sm text-gray-600 dark:text-gray-400 mt-1">{selectedIntervention.technicien.email}</p>
                    )}
                  </div>
                </div>
              )}
              ...
              {selectedIntervention.description && (
                <div className="flex items-start gap-3 p-4 bg-green-50 dark:bg-green-900/20 rounded-xl border border-green-200 dark:border-green-700">
                  <FileText className="w-5 h-5 text-green-600 dark:text-green-400 mt-1 flex-shrink-0" />
                  <div className="flex-1">
              ...
              {/* Priorité */}
              {selectedIntervention.priorite && (
                <div className="flex items-start gap-3 p-4 bg-orange-50 dark:bg-orange-900/20 rounded-xl border border-orange-200 dark:border-orange-700">
                  <Clock className="w-5 h-5 text-orange-600 dark:text-orange-400 mt-1 flex-shrink-0" />
                  <div>
                    <p className="font-semibold text-gray-800 dark:text-white mb-2">Priorité</p>
                    <span className={`inline-flex items-center gap-1.5 px-3 py-1.5 rounded-full text-sm font-bold ${
                      selectedIntervention.priorite === 'haute' ? 'bg-red-100 dark:bg-red-900/30 text-red-800 dark:text-red-300' :
                      selectedIntervention.priorite === 'moyenne' ? 'bg-yellow-100 dark:bg-yellow-900/30 text-yellow-800 dark:text-yellow-300' :
                  ...
                  <div className="space-y-2 ml-7">
                    {selectedIntervention.demande.numeroReference && (
                      <p className="text-sm">
                        ...
                        <span className="text-gray-600 dark:text-gray-400">{selectedIntervention.demande.numeroReference}</span>
                      </p>
                    )}
                    {selectedIntervention.demande.titre && (
                      <p className="text-sm">
                        <span className="font-medium text-gray-700 dark:text-gray-300">Titre: </span>
                        <span className="text-gray-600 dark:text-gray-400">{selectedIntervention.demande.titre}</span>
                      </p>
                    )}
                    {selectedIntervention.demande.description && (
                      <p className="text-sm">
                        <span className="font-medium text-gray-700 dark:text-gray-300">Description: </span>
                        <span className="text-gray-600 dark:text-gray-400">{selectedIntervention.demande.description}</span>
                      </p>
                    )}
                    {selectedIntervention.demande.demandeur && (
                      <p className="text-sm">
                        <span className="font-medium text-gray-700 dark:text-gray-300">Demandeur: </span>
                    ...
                    {selectedIntervention.demande.email && (
                      <p className="text-sm">
                        ...
                        <span className="text-gray-600 dark:text-gray-400">{selectedIntervention.demande.email}</span>
                      </p>
                    )}
                  </div>
                </div>
            ...
            <div className="p-6 border-t bg-gray-50 dark:bg-gray-700 flex justify-end">
              <button
                onClick={closeModal}
                className="px-6 py-2.5 bg-gradient-to-r from-gray-200 to-gray-300 dark:from-gray-600 dark:to-gray-500 hover:from-gray-300 hover:to-gray-400 dark:hover:from-gray-500 dark:hover:to-gray-400 text-gray-800 dark:text-gray-200 font-semibold rounded-xl transition-all duration-200 shadow-sm hover:shadow-md"
              >
                Fermer
              </button>
            </div>
