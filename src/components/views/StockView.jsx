  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-50 to-blue-50/30 dark:from-gray-900 dark:to-blue-900/20 p-6">
      ...
      <div className="mb-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-4 mb-6">
          <div className="bg-white dark:bg-gray-800 rounded-2xl p-6 shadow-lg border border-gray-100 dark:border-gray-700">
            <div className="flex items-center justify-between">
              <div>
                <p className="text-sm font-medium text-gray-600 dark:text-gray-400">Total Matériels</p>
          ...
          <div className="bg-white dark:bg-gray-800 rounded-2xl p-6 shadow-lg border border-gray-100 dark:border-gray-700">
            <div className="flex items-center justify-between">
              <div>
                <p className="text-sm font-medium text-gray-600 dark:text-gray-400">Emprunts Actifs</p>
                <p className="text-2xl font-bold text-blue-600 dark:text-blue-400">{empruntsActifs.length}</p>
              </div>
              <div className="p-3 bg-blue-100 dark:bg-blue-900/30 rounded-xl">
        ...
        <div className="flex flex-col lg:flex-row gap-4">
          <div className="flex-1 relative">
            <input
              ...
              value={searchTerm}
              onChange={(e) => setSearchTerm(e.target.value)}
              className="w-full pl-4 pr-4 py-3 bg-gray-50 dark:bg-gray-700 border border-gray-200 dark:border-gray-600 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-all duration-200 text-gray-900 dark:text-white placeholder-gray-500 dark:placeholder-gray-400"
            />
          </div>
          ...
          <div className="flex gap-3">
            <select
              value={sortBy}
              onChange={(e) => setSortBy(e.target.value)}
              className="px-4 py-3 bg-gray-50 dark:bg-gray-700 border border-gray-200 dark:border-gray-600 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-blue-500 text-gray-900 dark:text-white"
            >
              <option value="nom">Trier par nom</option>
              <option value="categorie">Trier par catégorie</option>
              <option value="disponible">Trier par disponibilité</option>
      ...
      <div className="grid grid-cols-1 xl:grid-cols-2 gap-8">
        ...
        <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-lg border border-gray-100 dark:border-gray-700 overflow-hidden">
          <div className="bg-gradient-to-r from-blue-50 to-indigo-50 dark:from-blue-900/20 dark:to-indigo-900/20 p-6 border-b border-gray-200 dark:border-gray-600">
            <div className="flex items-center gap-3">
              ...
              <div>
                <h3 className="text-xl font-semibold text-gray-900 dark:text-white">Inventaire des Matériels</h3>
                <p className="text-gray-600 dark:text-gray-400 text-sm">{stock.length} matériel(s) au total</p>
              </div>
            </div>
          </div>
          ...
          <div className="p-6 space-y-4 max-h-[600px] overflow-y-auto">
            {filteredStock.map(materiel => (
              <div key={materiel._id} className="group p-4 bg-gray-50 dark:bg-gray-700/50 rounded-xl border border-gray-200 dark:border-gray-600 hover:shadow-md transition-all duration-300">
                <div className="flex justify-between items-center">
                  <div className="flex-1">
                    <div className="flex items-center gap-3 mb-2">
                      <h4 className="font-semibold text-gray-900 dark:text-white">{materiel.nom}</h4>
                    ...
                    <div className="flex items-center gap-6">
                      <div className="flex items-center gap-2">
                        <div className="w-2 h-2 bg-green-500 rounded-full"></div>
                        <span className="text-sm text-gray-600 dark:text-gray-400">Disponible: {materiel.disponible}</span>
                      </div>
                      <div className="flex items-center gap-2">
                        <div className="w-2 h-2 bg-gray-400 dark:bg-gray-500 rounded-full"></div>
                        <span className="text-sm text-gray-600 dark:text-gray-400">Total: {materiel.quantite}</span>
                      </div>
                    </div>
                  ...
                  {canManageStock() && (
                    <div className="flex gap-2 opacity-0 group-hover:opacity-100 transition-opacity duration-300">
                      <button
                        onClick={() => handleEditMateriel(materiel)}
                        className="p-2 bg-blue-100 dark:bg-blue-900/30 hover:bg-blue-200 dark:hover:bg-blue-800/50 text-blue-600 dark:text-blue-400 rounded-xl transition-all duration-200 hover:scale-110"
                        title="Modifier"
                      >
                        <Edit size={18} />
                      </button>
                      <button
                        onClick={() => handleDeleteMateriel(materiel._id)}
                        className="p-2 bg-red-100 dark:bg-red-900/30 hover:bg-red-200 dark:hover:bg-red-800/50 text-red-600 dark:text-red-400 rounded-xl transition-all duration-200 hover:scale-110"
                        title="Supprimer"
                        disabled={!onDeleteMateriel}
                      >
                        <Trash2 size={18} />
            ...
            {filteredStock.length === 0 && (
              <div className="text-center py-12">
                ...
                <p className="text-gray-500 dark:text-gray-400 text-lg">Aucun matériel trouvé</p>
                {searchTerm && (
                  <p className="text-gray-400 dark:text-gray-500 text-sm mt-2">Aucun résultat pour "{searchTerm}"</p>
                )}
              </div>
            )}
          </div>
        ...
        {/* Section Emprunts */}
        <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-lg border border-gray-100 dark:border-gray-700 overflow-hidden">
          <div className="bg-gradient-to-r from-green-50 to-emerald-50 dark:from-green-900/20 dark:to-emerald-900/20 p-6 border-b border-gray-200 dark:border-gray-600">
            <div className="flex items-center gap-3">
              <div className="p-2 bg-green-100 dark:bg-green-900/30 rounded-lg">
                <Users size={24} className="text-green-600 dark:text-green-400" />
              </div>
              <div>
                <h3 className="text-xl font-semibold text-gray-900 dark:text-white">Emprunts en Cours</h3>
                <p className="text-gray-600 dark:text-gray-400 text-sm">{empruntsActifs.length} emprunt(s) actif(s)</p>
              </div>
            </div>
          </div>
          ...
          <div className="p-6 space-y-4 max-h-[600px] overflow-y-auto">
            {filteredEmprunts.map(emprunt => {
              ...
              return (
                <div key={emprunt._id} className={`p-4 rounded-xl border-l-4 transition-all duration-300 ${
                  estEnRetard 
                    ? 'bg-red-50 dark:bg-red-900/20 border-red-500 dark:border-red-400 hover:shadow-md' 
                    : 'bg-yellow-50 dark:bg-yellow-900/20 border-yellow-500 dark:border-yellow-400 hover:shadow-md'
                }`}>
                  <div className="flex justify-between items-start">
                    <div className="flex-1">
                      <div className="flex items-center gap-3 mb-2">
                        <h4 className="font-semibold text-gray-900 dark:text-white">{emprunt.materiel?.nom || materiel?.nom}</h4>
                        {estEnRetard && (
                          <span className="px-2 py-1 bg-red-100 dark:bg-red-900/30 text-red-700 dark:text-red-300 text-xs rounded-full font-medium flex items-center gap-1">
                            <AlertTriangle size={12} />
                            En retard
                          </span>
                        )}
            ...
            {filteredEmprunts.length === 0 && (
              <div className="text-center py-12">
                ...
                <p className="text-gray-500 dark:text-gray-400 text-lg">Aucun emprunt en cours</p>
                {searchTerm && (
                  <p className="text-gray-400 dark:text-gray-500 text-sm mt-2">Aucun résultat pour "{searchTerm}"</p>
                )}
              </div>
...
const MaterielModal = ({ materiel, onSave, onClose, loading }) => {
  ...
  return (
    <div className="fixed inset-0 bg-black/60 backdrop-blur-sm flex items-center justify-center p-4 z-50">
      <div className="bg-gradient-to-br from-white to-gray-50/80 dark:from-gray-800 dark:to-gray-700/80 rounded-2xl border border-gray-200/80 dark:border-gray-600/80 shadow-2xl w-full max-w-md">
        <div className="bg-gradient-to-r from-blue-600 to-purple-600 p-6">
          <div className="flex justify-between items-center">
            <div>
              <h3 className="text-xl font-bold text-white">
        ...
        <form onSubmit={handleSubmit} className="p-6 space-y-5">
          <div className="group">
            ...
            <input
              ...
              value={formData.nom}
              onChange={(e) => setFormData(prev => ({...prev, nom: e.target.value}))}
              className="w-full px-4 py-3 bg-white dark:bg-gray-700 border border-gray-300 dark:border-gray-600 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-all duration-200 shadow-sm hover:shadow-md text-gray-900 dark:text-white"
              placeholder="Nom du matériel"
              required
              disabled={loading}
            />
          ...
          <div className="group">
            ...
            <input
              ...
              value={formData.categorie}
              onChange={(e) => setFormData(prev => ({...prev, categorie: e.target.value}))}
              className="w-full px-4 py-3 bg-white dark:bg-gray-700 border border-gray-300 dark:border-gray-600 rounded-xl focus:ring-2 focus:ring-purple-500 focus:border-purple-500 transition-all duration-200 shadow-sm hover:shadow-md text-gray-900 dark:text-white"
              placeholder="Catégorie"
              required
              disabled={loading}
            />
          ...
          <div className="grid grid-cols-2 gap-4">
            <div className="group">
              ...
              <input
                ...
                value={formData.quantite}
                onChange={(e) => handleQuantiteChange(e.target.value)}
                className="w-full px-4 py-3 bg-white dark:bg-gray-700 border border-gray-300 dark:border-gray-600 rounded-xl focus:ring-2 focus:ring-green-500 focus:border-green-500 transition-all duration-200 shadow-sm hover:shadow-md text-gray-900 dark:text-white"
                required
                disabled={loading}
              />
            </div>
            ...
            <div className="group">
              ...
              <input
                ...
                value={formData.disponible}
                onChange={(e) => setFormData(prev => ({...prev, disponible: parseInt(e.target.value) || 0}))}
                className="w-full px-4 py-3 bg-white dark:bg-gray-700 border border-gray-300 dark:border-gray-600 rounded-xl focus:ring-2 focus:ring-orange-500 focus:border-orange-500 transition-all duration-200 shadow-sm hover:shadow-md text-gray-900 dark:text-white"
                required
                disabled={loading}
              />
            </div>
          ...
          <div className="flex gap-3 justify-end pt-6 border-t border-gray-200 dark:border-gray-600">
            <button
              type="button"
              onClick={onClose}
              className="px-6 py-3 bg-white dark:bg-gray-700 border border-gray-300 dark:border-gray-600 text-gray-700 dark:text-gray-300 rounded-xl hover:bg-gray-50 dark:hover:bg-gray-600 hover:shadow-md transition-all duration-200 font-semibold"
              disabled={loading}
            >
              Annuler
            </button>
