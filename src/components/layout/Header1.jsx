...
// VERSION AVEC LE MODE SOMBRE ET LE TOGGLE THEME
...
//           </div>
//           <div>
//             <h1 className="text-2xl font-bold text-gray-800 dark:text-white transition-colors duration-200">CRT-ESMT</h1>
//             <p className="text-xs text-gray-500 dark:text-gray-400 transition-colors duration-200">Centre des Ressources Techniques</p>
//           </div>
//         </div>
...
//                         {currentUser?.prenom} {currentUser?.nom}
//                       </p>
//                       <p className="text-xs text-gray-600 dark:text-gray-300 transition-colors duration-200">{currentUser?.email}</p>
//                     </div>
//                   </div>
//                 </div>
...
//   // ✅ AJOUT : Afficher un message si currentUser est null
//   if (!currentUser) {
...
// NOUVELLE VERSION POUR LE BOUTON "RETOUR"
...
const Header = ({ setActiveView, showUserMenu, setShowUserMenu }) => {
  // ✅ MODIFICATION : Utiliser les props passées depuis l'App ou l'état local en fallback
  ...
  // ✅ MODIFICATION : Utiliser les props si elles sont fournies, sinon l'état local
  ...
  // ✅ MODIFICATION : Fonction pour basculer le menu utilisateur
    ...
    <p className="text-xs text-gray-500 dark:text-gray-400 transition-colors duration-200">
      Centre des Ressources Techniques
        ...
        <div className="flex items-center gap-4" ref={menuRef}>
          ...
          {/* Menu Utilisateur */}
          <div className="relative">
            {/* ✅ MODIFICATION : Utiliser la nouvelle fonction handleUserMenuToggle */}
            <button
            ...
            {/* ✅ MODIFICATION : Utiliser actualShowUserMenu au lieu de showUserMenu */}
            {actualShowUserMenu && (
              <div className="absolute right-0 mt-2 w-56 bg-white dark:bg-dark-800 rounded-lg shadow-xl z-50 border border-gray-200 dark:border-dark-600 transition-colors duration-200">
                <div className="p-4 border-b border-gray-200 dark:border-dark-600 bg-gradient-to-r from-blue-50 to-indigo-50 dark:from-blue-900/20 dark:to-indigo-900/20">
                  <div className="flex items-center gap-3">
