...
//   // ✅ Fonction pour formater le nom de l'équipement (supprime les underscores)
...
//                     {/* ✅ CHAMP MATÉRIEL MIS À JOUR AVEC LISTE DÉROULANTE */}
//                     <div className="group">
//                       <label className="flex items-center gap-2 text-sm font-semibold text-gray-700 mb-3">
//                         <div className="w-2 h-2 bg-orange-500 rounded-full"></div>
//                         Équipement concerné
...
//                         <optgroup label="Équipements Informatiques">
...
//                           ))}
//                         </optgroup>
//                         <optgroup label="Équipements Électriques">
...
//   // ✅ CORRECTION : Déterminer si le technicien veut terminer son intervention
//   const isTechnicianFinishing = 
//     currentUser?.role !== 'admin' && 
//     intervention && 
//     intervention.statut === 'en_cours' && 
//     formData.statut === 'en_attente_validation';

//   const canOnlyUploadFiles = isTechnicianFinishing;

//   // ✅ CORRECTION : Vérifier si l'admin peut valider une intervention
//   const canAdminValidate = 
//     currentUser?.role === 'admin' && 
//     intervention?.statut === 'en_attente_validation';

//   // ✅ CORRECTION : Modifier la logique canModifyFiles
//   const canModifyFiles = currentUser?.role === 'admin' || 
//     (intervention && intervention.technicien?._id === currentUser?.id) ||
//     canOnlyUploadFiles;
...
//     switch (statut) {
//       case 'terminee': return <CheckCircle2 size={16} className="text-green-600" />;
//       case 'en_attente_validation': return <AlertCircle size={16} className="text-orange-600" />;
//       case 'en_cours': return <div className="w-3 h-3 rounded-full bg-yellow-500 animate-pulse" />;
//       case 'planifiee': return <Calendar size={16} className="text-blue-600" />;
//       default: return <AlertCircle size={16} className="text-gray-600" />;
//     }
...
//   // ✅ CORRECTION : Options de statut selon le rôle
...
//         { value: 'planifiee', label: 'Planifiée' },
//         { value: 'en_cours', label: 'En cours' },
//         { value: 'en_attente_validation', label: 'Terminer l\'intervention' }
//       ];
//     }
//   };
...
//             <div>
//               <h3 className="text-2xl font-bold text-white">
//                 {canOnlyUploadFiles ? 'Finaliser l\'intervention' : 
//                  canAdminValidate ? 'Valider l\'intervention' :
//                  intervention ? 'Modifier l\'intervention' : 'Nouvelle intervention'}
//               </h3>
//               <p className="text-blue-100 mt-1">
//                 {canOnlyUploadFiles 
//                   ? 'Ajoutez les fichiers nécessaires avant de terminer' 
//                   : canAdminValidate
//                   ? 'Validez cette intervention terminée par le technicien'
//                   : intervention 
//                     ? 'Mettez à jour les détails de l\'intervention' 
//                     : 'Créez une nouvelle intervention'
//                 }
...
//             {/* Message pour l'admin qui valide */}
//             {canAdminValidate && (
//               <div className="mb-6 p-4 bg-green-50 border-2 border-green-300 rounded-xl">
//                 <div className="flex items-center gap-3">
//                   <CheckCircle2 size={24} className="text-green-600 flex-shrink-0" />
//                   <div>
//                     <p className="text-sm font-bold text-green-900">Validation de l'intervention</p>
//                     <p className="text-sm text-green-800 mt-1">
//                       Cette intervention a été marquée comme terminée par le technicien. 
//                       Vérifiez les fichiers joints et validez l'intervention.
//                     </p>
//                   </div>
//                 </div>
//               </div>
...
//             {/* Section Informations principales - MASQUÉE pour les techniciens en fin d'intervention */}
//             {!canOnlyUploadFiles && !canAdminValidate && (
//               <>
//                 <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
//                   {/* Colonne gauche */}
//                   <div className="space-y-6">
...
//                         onChange={(e) => setFormData({...formData, statut: e.target.value})}
//                         className="w-full px-4 py-3 bg-white border border-gray-300 rounded-xl focus:ring-2 focus:ring-gray-500 focus:border-gray-500 transition-all duration-200 shadow-sm hover:shadow-md"
//                         disabled={loading || canAdminValidate}
//                       >
...
//             {/* SECTION FICHIERS */}
//             {intervention && canModifyFiles && (
//               <div className={`pt-6 mt-6 ${canOnlyUploadFiles || canAdminValidate ? '' : 'border-t border-gray-200'}`}>
//                 <div className="flex items-center gap-3 mb-4">
//                   <div className="p-2 bg-blue-100 rounded-lg">
//                     <FileText size={20} className="text-blue-600" />
//                   </div>
//                   <div>
//                     <h4 className="text-lg font-semibold text-gray-800">
//                       {canOnlyUploadFiles ? 'Ajouter les fichiers requis' : 
//                        canAdminValidate ? 'Fichiers de l\'intervention' : 'Fichiers attachés'}
//                     </h4>
//                     <p className="text-sm text-gray-600">
//                       {canOnlyUploadFiles 
//                         ? 'Photos, rapports d\'intervention, documents' 
//                         : canAdminValidate
//                         ? 'Vérifiez les fichiers joints par le technicien'
//                         : 'Documents, photos et supports'
//                       }
//                     </p>
//                   </div>
...
//                 {/* Upload de nouveaux fichiers (uniquement pour technicien qui termine) */}
//                 {canOnlyUploadFiles && (
//                   <div className="border-2 border-dashed border-gray-300 rounded-2xl p-6 hover:border-blue-400 transition-all duration-300 bg-gradient-to-br from-white to-blue-50/50">
//                     <input
//                       key={fileInputKey}
...
// NOUVELLE VERSION CLAUDE AVEC AJOUT DE FONCTION : Valider une intervention (admin)
...
//                 type="submit"
//                 className="px-8 py-3 bg-gradient-to-r from-blue-600 to-purple-600 hover:from-blue-700 hover:to-purple-700 text-white rounded-xl shadow-lg hover:shadow-xl transition-all duration-200 font-semibold disabled:opacity-50 disabled:cursor-not-allowed transform hover:scale-105"
//                 // ✅ CORRECTION : Retirer canAdminValidate de la condition disabled
//                 disabled={loading || uploading}
//               >
//                 {loading ? (
//                   <div className="flex items-center gap-2">
...
// NOUVELLE VERSION DEEPSEEK POUR AJOUTER UNE FONCTION DE VALIDATION POUR L'ADMIN ET UPLOAD DE FICHIERS POUR LE TECHNICIEN
...
//   useEffect(() => {
//     if (intervention) {
//       // ✅ CORRECTION : Toujours mettre le statut à 'en_attente_validation' quand le technicien termine
//       const statutToUse = isTechnicianFinishing ? 'en_attente_validation' : intervention.statut;
...
//       }
//     }
//   }, [intervention, isTechnicianFinishing]);
...
//     if (canOnlyUploadFiles) {
//       // ✅ CORRECTION : Envoyer uniquement le changement de statut pour le technicien qui termine
//       await onSave({ statut: 'en_attente_validation' }, intervention?._id);
//     } else {
//       await onSave(formData, intervention?._id);
//     }
//   };
...
//               <p className="text-blue-100 mt-1">
//                 {canOnlyUploadFiles 
//                   ? 'Ajoutez les fichiers nécessaires pour terminer l\'intervention' 
//                   : canAdminValidate
//                   ? 'Validez cette intervention terminée par le technicien'
//                   : intervention 
//                     ? 'Mettez à jour les détails de l\'intervention' 
...
//             {/* ✅ CORRECTION : Message informatif pour les techniciens qui terminent */}
//             {canOnlyUploadFiles && (
//               <div className="mb-6 p-4 bg-yellow-50 border-2 border-yellow-300 rounded-xl">
//                 <div className="flex items-center gap-3">
//                   <AlertCircle size={24} className="text-yellow-600 flex-shrink-0" />
...
//                     <p className="text-sm font-bold text-yellow-900">Finalisation de l'intervention</p>
//                     <p className="text-sm text-yellow-800 mt-1">
//                       Vous êtes sur le point de terminer cette intervention. Veuillez ajouter les fichiers nécessaires 
//                       (photos, rapports d'intervention, documents) avant de finaliser. Une fois terminée, 
//                       l'intervention sera soumise à l'administrateur pour validation.
//                     </p>
//                   </div>
//                 </div>
//               </div>
...
//             {/* ✅ CORRECTION : Section Informations principales - MASQUÉE pour les techniciens qui terminent */}
//             {!canOnlyUploadFiles && !canAdminValidate && (
//               <>
//                 <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
//                   {/* Colonne gauche */}
...
//                             <option value="planifiee">Planifiée</option>
//                             <option value="en_cours">En cours</option>
//                             <option value="en_attente_validation">Terminer l'intervention</option>
//                           </>
//                         )}
//                       </select>
//                     </div>
...
//             {/* ✅ CORRECTION : SECTION FICHIERS - TOUJOURS VISIBLE pour upload et consultation */}
//             {intervention && canModifyFiles && (
//               <div className={`pt-6 ${canOnlyUploadFiles || canAdminValidate ? '' : 'border-t border-gray-200'}`}>
//                 <div className="flex items-center gap-3 mb-4">
//                   <div className="p-2 bg-blue-100 rounded-lg">
//                     <FileText size={20} className="text-blue-600" />
//                   </div>
...
//                     <p className="text-sm text-gray-600">
//                       {canOnlyUploadFiles 
//                         ? 'Photos, rapports d\'intervention, documents (obligatoire)' 
//                         : canAdminValidate
//                         ? 'Vérifiez les fichiers joints par le technicien'
//                         : 'Documents, photos et supports'
//                       }
...
//                   <div className="mb-6">
//                     <h5 className="font-medium mb-3 text-gray-700 text-sm uppercase tracking-wide">
//                       {canOnlyUploadFiles ? 'Fichiers déjà uploadés' : 'Fichiers existants'}
//                     </h5>
//                     <div className="space-y-3 max-h-48 overflow-y-auto pr-2">
//                       {intervention.fichiers.map((fichier) => (
//                         <div key={fichier._id} className="flex items-center justify-between p-4 bg-white border border-gray-200 rounded-xl hover:shadow-md transition-all duration-200">
...
//                 {/* ✅ CORRECTION : Upload de nouveaux fichiers - OBLIGATOIRE pour technicien qui termine */}
//                 {canOnlyUploadFiles && (
//                   <div className="border-2 border-dashed border-gray-300 rounded-2xl p-6 hover:border-blue-400 transition-all duration-300 bg-gradient-to-br from-white to-blue-50/50">
//                     <input
//                       key={fileInputKey}
...
// NOUVELLE VERSION POUR AJOUTER UNE LISTE DEROULANTE POUR LE CHAMP MATERIEL ET REGLER LUPLOAD DES FICHIERS POUR LE TECHNICIEN QUI TERMINE L'INTERVENTION
...
//   // ✅ AJOUT : État pour stocker les équipements
//   const [equipements, setEquipements] = useState({
//     categories: { INFORMATIQUE: [], ELECTRIQUE: [] },
//     allEquipements: []
//   });
...
//   // ✅ CORRECTION : Logique de finalisation du technicien
//   const isTechnicianFinishing =
//     isTechnician &&
//     intervention &&
//     (
//       // Cas 1 : l'intervention originale est en_cours et on vise terminee
//       (intervention.statut === 'en_cours' && formData.statut === 'terminee') ||
//       // Cas 2 : flag explicite de finalisation
//       intervention._pendingStatusChange === true
//     );

//   // ✅ CORRECTION : Un technicien ne voit QUE l'upload quand il termine
//   const canOnlyUploadFiles = isTechnicianFinishing;
...
//   const userId = currentUser?._id ?? currentUser?.id;
//   const techId = intervention?.technicien?._id ?? intervention?.technicien?.id;
//   const canModifyFiles = isAdmin || (intervention && techId && userId && techId === userId);
...
//   // ✅ AJOUT : Charger les équipements au montage du composant
//   useEffect(() => {
//     const loadEquipements = async () => {
//       try {
//         const data = await getEquipements();
...
//   useEffect(() => {
//     if (intervention) {
//       // ✅ CORRECTION : Si finalisation en attente, forcer le statut "en_attente_validation"
//       const statutToUse = isTechnicianFinishing ? 'en_attente_validation' : intervention.statut;
...
//   // ✅ AJOUT : Fonction pour formater le nom de l'équipement (supprime les underscores)
//   const formatEquipementName = (equipement) => {
//     return equipement.replace(/_/g, ' ');
//   };
...
//     // ✅ CORRECTION : Un technicien ne peut soumettre UNIQUEMENT en flux de finalisation
//     if (isTechnician && !isTechnicianFinishing) {
//       return; // Pas de submit hors finalisation
//     }

//     if (isTechnicianFinishing) {
//       // ✅ CORRECTION : Pour le technicien qui termine, envoyer uniquement le changement de statut
//       await onSave({ statut: 'en_attente_validation' }, intervention?._id);
//     } else {
//       await onSave(formData, intervention?._id);
//     }
...
//   // ✅ CORRECTION : Titre + sous-titre dynamiques
//   const headerTitle = isAdmin
//     ? (intervention ? "Modifier l'intervention" : "Nouvelle intervention")
//     : (isTechnicianFinishing ? "Finaliser l'intervention" : "Modifier l'intervention");
...
//             {/* ✅ CORRECTION : Section Informations principales - MASQUÉE pour les techniciens qui terminent */}
//             {!isTechnicianFinishing && !canAdminValidate && (
//               <>
//                 <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
//                   {/* Colonne gauche */}
//                   <div className="space-y-6">
...
//                     {/* ✅ AJOUT : CHAMP MATÉRIEL AVEC LISTE DÉROULANTE */}
//                     <div className="group">
//                       <label className="flex items-center gap-2 text-sm font-semibold text-gray-700 mb-3">
//                         <div className="w-2 h-2 bg-orange-500 rounded-full"></div>
//                         Équipement concerné
...
//             {/* ✅ CORRECTION : SECTION FICHIERS - TOUJOURS VISIBLE */}
//             {intervention && canModifyFiles && (
//               <div className={`pt-6 ${isTechnicianFinishing || canAdminValidate ? '' : 'border-t border-gray-200'}`}>
//                 <div className="flex items-center gap-3 mb-4">
//                   <div className="p-2 bg-blue-100 rounded-lg">
//                     <FileText size={20} className="text-blue-600" />
//                   </div>
//                   <div>
//                     <h4 className="text-lg font-semibold text-gray-800">
//                       {isTechnicianFinishing ? 'Ajouter les fichiers requis' : 
//                        canAdminValidate ? 'Fichiers de l\'intervention' : 'Fichiers attachés'}
//                     </h4>
//                     <p className="text-sm text-gray-600">
//                       {isTechnicianFinishing 
...
//                   <div className="mb-6">
//                     <h5 className="font-medium mb-3 text-gray-700 text-sm uppercase tracking-wide">
//                       {isTechnicianFinishing ? 'Fichiers déjà uploadés' : 'Fichiers existants'}
//                     </h5>
//                     <div className="space-y-3 max-h-48 overflow-y-auto pr-2">
//                       {intervention.fichiers.map((fichier) => (
//                         <div key={fichier._id} className="flex items-center justify-between p-4 bg-white border border-gray-200 rounded-xl hover:shadow-md transition-all duration-200">
...
//               {/* ✅ CORRECTION : Submit visible UNIQUEMENT pour admin OU technicien en finalisation */}
//               {(isAdmin || isTechnicianFinishing) && (
//                 <button
//                   type="submit"
//                   className="px-8 py-3 bg-gradient-to-r from-blue-600 to-purple-600 hover:from-blue-700 hover:to-purple-700 text-white rounded-xl shadow-lg hover:shadow-xl transition-all duration-200 font-semibold disabled:opacity-50 disabled:cursor-not-allowed transform hover:scale-105"
...
// import { Upload, X, FileText, Image, Download, Trash2, Building, MapPin, Calendar, Clock, User, AlertCircle, CheckCircle2 } from 'lucide-react';
// import { uploadFiles, deleteFile } from '../../services/fileService';
// import { getEquipements } from '../../services/interventionService';
...
//   // Logique de finalisation du technicien
//   const isTechnicianFinishing =
//     isTechnician &&
//     intervention &&
//     (
...
//   // Permissions d'upload (admin OU technicien assigné)
//   const userId = currentUser?._id ?? currentUser?.id;
//   const techId = intervention?.technicien?._id ?? intervention?.technicien?.id;
//   const canModifyFiles = isAdmin || (intervention && techId && userId && techId === userId) || canOnlyUploadFiles;
...
//                     {/* CHAMP MATÉRIEL AVEC LISTE DÉROULANTE */}
//                     <div className="group">
//                       <label className="flex items-center gap-2 text-sm font-semibold text-gray-700 mb-3">
//                         <div className="w-2 h-2 bg-orange-500 rounded-full"></div>
//                         Équipement concerné
...
//   // ✅ NOUVEAU : Vérifier si l'admin valide une intervention en attente
//   const isAdminValidating = isAdmin && intervention?.statut === 'en_attente_validation';
...
//   // ✅ CORRECTION CRITIQUE : Logique de finalisation du technicien
//   const isTechnicianFinishing =
//     isTechnician &&
//     intervention &&
//     intervention.statut === 'en_cours' &&
...
//     canOnlyUploadFiles,
//     canModifyFiles,
//     hasPendingChange: intervention?._pendingStatusChange
//   });
...
//   useEffect(() => {
//     if (intervention) {
//       // ✅ CORRECTION : Toujours utiliser le statut réel de l'intervention
//       // Le _pendingStatusChange est juste un flag pour le comportement modal
//       const statutToUse = intervention.statut;
...
//     if (canOnlyUploadFiles) {
//       // ✅ CORRECTION : Le technicien met en attente de validation, pas terminée
//       console.log('📤 Technicien soumet pour validation');
//       await onSave({ statut: 'en_attente_validation' }, intervention?._id);
//     } else {
//       await onSave(formData, intervention?._id);
//     }
...
//               <p className="text-blue-100 mt-1">
//                 {canOnlyUploadFiles 
//                   ? 'Ajoutez les fichiers nécessaires avant de soumettre pour validation' 
//                   : intervention 
//                     ? 'Mettez à jour les détails de l\'intervention' 
//                     : 'Créez une nouvelle intervention'
//                 }
...
//                   <div>
//                     <p className="text-sm font-bold text-orange-900">Soumission pour validation</p>
//                     <p className="text-sm text-orange-800 mt-1">
//                       Veuillez ajouter les fichiers nécessaires (photos, rapports d'intervention) avant de soumettre. 
//                       L'intervention sera mise en attente de validation par un administrateur.
//                     </p>
//                   </div>
//                 </div>
//               </div>
...
//                         onChange={(e) => setFormData({...formData, statut: e.target.value})}
//                         className="w-full px-4 py-3 bg-white border border-gray-300 rounded-xl focus:ring-2 focus:ring-gray-500 focus:border-gray-500 transition-all duration-200 shadow-sm hover:shadow-md"
//                         disabled={loading || (isTechnician && intervention)}
//                       >
//                         <option value="planifiee">Planifiée</option>
//                         <option value="en_cours">En cours</option>
//                         <option value="en_attente_validation">En attente de validation</option>
...
//                           Fichiers à uploader ({selectedFiles.length}/5)
//                         </h6>
//                         {selectedFiles.map((file, index) => (
...
//                             className="flex items-center gap-2 px-4 py-2 bg-blue-600 hover:bg-blue-700 disabled:bg-gray-400 text-white rounded-lg transition-all duration-200 font-medium"
//                           >
//                             {uploading ? (
//                               <>
...
//                 type="button"
//                 onClick={onClose}
//                 className="px-6 py-3 bg-gray-200 hover:bg-gray-300 rounded-xl transition-all duration-200 font-medium shadow-sm hover:shadow-md"
//                 disabled={loading}
//               >
//                 Annuler
//               </button>
...
//                   <div className="flex items-center gap-2">
//                     <div className="w-4 h-4 border-2 border-white border-t-transparent rounded-full animate-spin" />
//                     {canOnlyUploadFiles ? 'Soumission...' : 'Sauvegarde...'}
//                   </div>
//                 ) : (
//                   canOnlyUploadFiles ? 'Soumettre pour validation' : (intervention ? 'Mettre à jour' : 'Créer l\'intervention')
//                 )}
//               </button>
//             </div>
//           </form>
...
const InterventionModal = ({ intervention, techniciens, onSave, onClose, loading, currentUser, sitesByBuilding }) => {
  ...
  // ✅ CORRECTION : Ajout de logs détaillés dans handleSubmit
  const handleSubmit = async (e) => {
    e.preventDefault();
    
    if (canOnlyUploadFiles) {
      // ✅ CORRECTION : Le technicien met en attente de validation, pas terminée
      console.log('📤 Technicien soumet pour validation - Statut à envoyer: en_attente_validation');
      console.log('🔍 Intervention avant envoi:', intervention);
      await onSave({ statut: 'en_attente_validation' }, intervention?._id);
    } else {
      console.log('📤 Admin modifie - Données à envoyer:', formData);
      await onSave(formData, intervention?._id);
    }
  };
