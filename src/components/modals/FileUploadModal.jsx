...
//   // ✅ FONCTION CORRIGÉE : Ouvrir les fichiers avec URL publique
//   const handleFileOpen = (fichier) => {
//     if (fichier._id.startsWith('temp-')) {
//       return;
//     }
...
//     if (fichier.url.startsWith('/public/uploads/')) {
//       // Nouveau format - URL publique
//       fileUrl = `http://localhost:5000${fichier.url}`;
//     } else if (fichier.url.startsWith('/uploads/')) {
//       // Ancien format - convertir en public
//       fileUrl = `http://localhost:5000/public${fichier.url}`;
//     } else if (fichier.url.startsWith('http')) {
//       // URL absolue
//       fileUrl = fichier.url;
//     } else {
//       // Fallback
//       fileUrl = `http://localhost:5000/public/uploads/${fichier.nom}`;
//     }
    
//     console.log('Tentative d\'ouverture:', fileUrl);
//     window.open(fileUrl, '_blank');
//   };

//   // ✅ FONCTION CORRIGÉE : Télécharger les fichiers
//   const handleFileDownload = (fichier) => {
//     if (fichier._id.startsWith('temp-')) {
//       return;
//     }
